...
export const MOCK_PRODUCTS: Product[] = [
  ...
  { id: 3, name: 'Iced Latte', description: 'Double espresso over ice with your choice of milk.', price: 140.00, categoryId: 2, categoryName: 'Iced Mana', image: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600', badges: ['10% OFF'], rating: 4.7, customizations: [MILK_OPTIONS, SUGAR_LEVEL], available: true },
  ...
  { id: 7, name: 'Cold Brew', description: 'Slow-steeped 18 hours for a smooth, low-acid cup.', price: 140.00, categoryId: 2, categoryName: 'Iced Mana', image: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=600', badges: [], rating: 4.7, customizations: [MILK_OPTIONS, SUGAR_LEVEL], available: true },
